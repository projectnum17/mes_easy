const morphAnimation = () => {
    ...
    const presets = [
        ...
        [
            'M460,350C430,420 370,460 310,470C250,480 190,520 140,485C90,450 70,370 60,310C50,250 30,200 55,140C80,80 150,60 210,40C270,20 340,30 400,60C460,90 510,140 520,210C530,280 500,310 460,350Z',
            'M455,325C420,390 360,440 300,450C240,460 180,500 130,470C80,440 60,360 70,300C80,240 35,190 55,130C75,70 145,45 205,25C265,5 335,25 390,55C445,85 500,135 515,200C530,265 500,285 455,325Z',
        ],
    ];
